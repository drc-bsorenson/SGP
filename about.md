...
The **SGP** Package (Betebenner, VanIwaarden, Domingue, Shang, 2017) is an open source package built for the open source **R** software environment (R Development Core Team, 2017). 
